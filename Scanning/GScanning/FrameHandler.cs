namespace GScanning
{
    ...
    /// Everytime the frame is processed it calls a user-specified action. The action is called in a new <see cref="Thread"/> by default but can be changed with a constructor or setter.
    ...
    public class FrameHandler
    {
        ...
        /// <summary>
        /// Indicates if action performed with every new frame should be called in a new thread.
        /// </summary>
